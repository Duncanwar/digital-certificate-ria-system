  ...
  return (
    ...
    >
      ...
      <p className="absolute top-[480px] left-[210px] text-sm text-black">
        <span className="font-bold">Architect in the year of {new Date().getFullYear()} as a professional senior corporate Member</span> of
        the Institute
      ...
      <span className="absolute top-[605px] left-[220px] text-sm text-black">A.74.17</span>
      <span className="absolute top-[635px] left-[75px] text-sm text-black">
        <img src="/sign_emm.png" alt="Signature Emmanuel" className="w-[200px] h-auto" />
      </span>
      ...
      <span className="absolute top-[635px] right-[115px] text-sm text-black">
        <img src="/sign_eu.png" alt="Signature Eudes" className="w-[200px] h-auto" />
      </span>

      <span className="absolute top-[670px] right-[140px] text-xs text-black">Arch. Eudes Kayumba</span>
      <span className="absolute top-[530px] right-[25px] text-sm text-black">
